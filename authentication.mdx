...
<Steps>
  <Step title="Create an account">
    Sign up at [blockline.soltop.sh](https://blockline.soltop.sh) if you haven't already
  </Step>
...
Visit your [API Keys dashboard](https://blockline.soltop.sh/dashboard/api-keys) to see:
...
Check your subscription status in the [Dashboard](https://blockline.soltop.sh/dashboard).
...
**Solution**: Visit [your dashboard](https://blockline.soltop.sh/dashboard) to activate or renew your subscription
