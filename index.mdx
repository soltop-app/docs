...
<Steps>
  <Step title="Get your API key">
    Sign up at [blockline.mevseer.com](https://blockline.mevseer.com) and generate your API key from the dashboard
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard" icon="gauge" href="https://blockline.mevseer.com">
