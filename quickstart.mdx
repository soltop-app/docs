...
- A Blockline account ([sign up here](https://blockline.mevseer.com))
...
<Steps>
  <Step title="Sign up for Blockline">
    Visit [blockline.mevseer.com](https://blockline.mevseer.com) and create an account. New users get a free trial to explore the API.
  </Step>

  <Step title="Navigate to API Keys">
    Once logged in, go to [Dashboard → API Keys](https://blockline.mevseer.com/dashboard/api-keys)
  </Step>
...
<ResponseField name="poh_tick_offset" type="integer">
  ...
  **Zero** = your transaction
  **Positive** = transaction happened after yours (potential back-runner)
</ResponseField>

<ResponseField name="slot_offset" type="integer">
  **Negative** = earlier slot/block
  **Zero** = same slot as your transaction
...
<AccordionGroup>
  ...
  <Accordion title="403 Forbidden">
    ...
    **Solution**: Ensure your subscription is active (trial, active, or grace period) at [your dashboard](https://blockline.mevseer.com/dashboard)
  </Accordion>

  <Accordion title="400 Bad Request">
    **Cause**: Invalid signature format or parameters
    **Solution**: Verify your signature is base58-encoded and 87-88 characters long
  </Accordion>
...
- Visit the [Dashboard](https://blockline.mevseer.com)
